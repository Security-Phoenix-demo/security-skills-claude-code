...
1. Load the skill at `${CLAUDE_PLUGIN_ROOT}/skills/threat-modeling/SKILL.md`.
...
- This is a **design-time** activity. For diff-level vuln checks use `/security-0day`; for full code sweep use `/security-audit`.

...
`<plugin>/skills/security-assessment/SKILL.md`.
...
- This is the heavy workflow. For PR/diff-only checks, use a 0-day scan instead (see `<plugin>/skills/0day-scanner/SKILL.md`).
- For STRIDE/DREAD threat modeling, use `<plugin>/skills/threat-modeling/SKILL.md`.

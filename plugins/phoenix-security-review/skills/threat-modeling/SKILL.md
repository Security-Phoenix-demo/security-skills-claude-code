...
description: >
  Automated STRIDE and DREAD threat modelling from code analysis. Extracts architecture,
  data flows, entry points and trust boundaries, then produces ranked threats, attack
  scenarios, mitigations and compliance-ready documentation. Use for security assessment,
  architecture review, compliance documentation and attack-scenario planning, or whenever
  someone says threat model this, STRIDE, DREAD, attack surface, data flow diagram or
  trust boundaries. Runs as Phase 0 of `tm-security-review`.
---

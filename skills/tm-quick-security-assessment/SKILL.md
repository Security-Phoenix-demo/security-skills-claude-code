...
- **`security-assessment`** (`../Security Assessment/security-assessment/SKILL.md`) — OWASP Top 10 checks, run only over changed files.
- **`0day-scanner`** (`../Security Assessment/0day-scanner/SKILL.md`) in **`light` mode** — it is built for commit/PR/branch/diff analysis; drive it with the branch or diff.
